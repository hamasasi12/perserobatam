...
<html lang="en">
  <head>
    ...
    <title>Resiko & Kepatuhan - NiceAdmin Bootstrap Template</title>
    <meta content="" name="description" />
    <meta content="" name="keywords" />

    <!-- Favicons -->
    <link href="{{ asset('./assets2/img/persero.png') }}" rel="icon" />
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
      <div class="d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          <img src="./assets2/img/persero.png" alt="" />
          <span class="d-none d-lg-block">Persero Batam</span>
        </a>
      ...
      <section class="section">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Form Resiko & Kepatuhan</h5>

                <form action="" method="post">
                  <div class="row mb-3">
                    <label for="nomor_barang" class="col-sm-2 col-form-label">No. Barang</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    <label for="nomor_serial_produk" class="col-sm-2 col-form-label">No. Serial Produk</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    <label for="tanggal_masuk_produk" class="col-sm-2 col-form-label">Tanggal Masuk Produk</label>
                    <div class="col-sm-10">
