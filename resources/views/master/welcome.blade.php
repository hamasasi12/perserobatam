        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="./assets/img/logo1.png" alt="" width="300" />
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <!-- ucapan -->
              <h4 class="mb-4" style="text-align: center; color: black; font-weight: bold">Selamat Datang di Aplikasi Manajemen Layanan Teknis Dan IT Persero Batam</h4>
              <!-- /ucapan -->
